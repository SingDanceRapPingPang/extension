...
public class Main_Phase4 {
    ...
    public static void main(String args[]){
        ...
        List<Graph> allFrequentGraphs = GSpanWrapper.loadGraph("E:\\2.txt");
        /**Get the info of the edge that needs to be contained in the graph**/
        List<Integer> edgeInfo = Util.readEdgeFromFile("E:\\2.txt");
        ...
        List<Graph> allFrequentGraphs_non_RT = GSpanWrapper.loadGraph("E:\\2.txt");
        /**Get the info of the edge that needs to be contained in the graph**/
        List<Integer> edgeInfo_non_RT = Util.readEdgeFromFile("E:\\2.txt");
