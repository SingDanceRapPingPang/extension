...
//                System.out.println(subject1.getCodes());
//                System.out.println("subject: " + subject1.getName());
//                System.out.println("predicate: " + predicate1.getPredicate());
//                try {
//                    System.out.println("object: " + objectOfPredicate1.getName());
//                }catch (Exception ignored){
//                    System.out.println("...........");
//                    System.out.println(objectOfPredicate1.getIsEntity());
//                    System.out.println(objectOfPredicate1.getEntityName());
//                    System.out.println(objectOfPredicate1.getValue());
//                    System.out.println("...........");
//                }
                /**create a triple **/
    ...
    public static List<Triple> filterPredicate(List<Triple> triples, String str){
        ...
        while (it.hasNext()){
            ...
            if(!triple.getPredicate().getValue().contains(str)){
